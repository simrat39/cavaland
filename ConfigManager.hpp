...
public:
    ...
    template <typename T>
    T get_or_default(const std::string &key, T def)
    {
    ...
    float get_or_default(const std::string &key, float def)
    {
        ...
        {
            std::cerr << e.what() << std::endl;
            std::cerr << "Expected type \"float\" for key " << key << ", falling back to default." << std::endl;
            return def;
        }
    }
    ...
    std::string get_or_default(const std::string &key, std::string def)
    {
        ...
        {
            std::cerr << e.what() << std::endl;
            std::cerr << "Expected type \"string\" for key " << key << ", falling back to default." << std::endl;
            return def;
        }
    }
